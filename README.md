https://github.com/burakorkmez/wallet-app-expo/tree/master

## 🎯 Serviços:

- Banco de dados: [Neon Tech](https://neon.com/)
- Limitar transação (Redis): [Upstash](https://upstash.com/)
- Hospedar servidor: [Render](https://render.com/)
- Autenticação de usuário: [Clerk](https://clerk.com/)
